...
-- CHỉnh sửa, thêm khóa ngoại các bảng
...
values (7934, 'MILLER', 'E7934', Str_To_Date('23-01-1982', '%d-%m-%Y'), 'CLERK', 1300, 10, 7698);
 ...
 -- Bảng salary_grade
insert into Salary_Grade (GRADE, HIGH_SALARY, LOW_SALARY) values (1, 9999, 3001);
